# experiment_mode/naive_bayes_experiment.py
...
def render():
    st.subheader("🔍 Naive Bayes – Experiment Mode")

    st.markdown("""
    **Naive Bayes** is a probabilistic classifier based on applying Bayes’ theorem with the “naive” assumption of conditional independence between features.

    Customize the parameters below and observe how the model performs:
    - Number of features (1 or 2 for visualization)
    - Number of classes
    - Noise level (label flipping)
    """)
